            ...
            if(degree == 0 || degree == 180){
                for(y = 0;y <4800; y++){
                    if(degree == 0){
                        ...
                        if(Systems.matrixSimulator.isPointNotEmpty(centre_x, centre_y + y,this.enemy.pointStatus)) break;
                    }
                    else {
                        if(pointsArray[centre_x][centre_y - y] != this.weight) pointsArray[centre_x][centre_y - y] += this.weight;
                        if(Systems.matrixSimulator.isPointNotEmpty(centre_x, centre_y - y,this.enemy.pointStatus)) break;
                ...
                for(x = 0;x <8400; x++){
                    if(degree == 90){
                        ...
                        if(Systems.matrixSimulator.isPointNotEmpty(centre_x + x, centre_y,this.enemy.pointStatus)) break;
                    }
                    else {
                        if(pointsArray[centre_x - x][centre_y] != this.weight) pointsArray[centre_x - x][centre_y] += this.weight;
                        if(Systems.matrixSimulator.isPointNotEmpty(centre_x - x, centre_y,this.enemy.pointStatus)) break;
                ...
                for(y = 0;y <4800; y++){
                    ...
                    if(Systems.matrixSimulator.isPointNotEmpty(centre_x + offset_x, centre_y + offset_y,this.enemy.pointStatus)) break;
                }
            }
            else{
                for(x = 0;x <8400; x++){
