...
import com.kristoff.robomaster_simulator.robomasters.modules.enemyobservations.EnemiesObservationSimulator;
...
public abstract class RoboMaster {
    ...
    public RoboMaster(String textureRegionPath, RoboMasterList roboMasterList, String name) {
